...
from ml_utils import optim_data, diagnostic, optim_bench, plot_loss, models_summary
...
# w0Bench = (1 + 1) * rng.random(8) - 1

#%% Class LogisticRegression

model0_1 = LogisticRegression().fit(X_train_apple, y_train_apple, X_test_apple, y_test_apple)
model0_2 = LogisticRegression(solver="Newton-CG").fit(X_train_apple, y_train_apple, X_test_apple, y_test_apple)
model0_3 = LogisticRegression(solver="CG").fit(X_train_apple, y_train_apple, X_test_apple, y_test_apple)
