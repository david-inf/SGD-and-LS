...
\begin{lstlisting}[style=simple,title={Mini-batch Gradient Descent with Armijo line search for step-size and Momentum correction}]
...
\cleardoublepage
\begin{lstlisting}[style=simple,title={Mini-batch Gradient Descent with Armijo line search for step-size and Momentum restart}]
